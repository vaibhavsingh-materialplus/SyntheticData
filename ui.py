...
def plot_from_text(column,dataset_instance):
    ...
    fig = get_column_plot(
        ...
        synthetic_data=dataset_instance.synthetic_data,
...
with gr.Blocks() as demo:
    ...
    # Plot display element
        ...
        plot_display = gr.Plot(label="Synthetic Data Plot")
    ...
    #plot for column_pair
        ...
        plot_display1 = gr.Plot(label="Synthetic Data Plot for Column Pair")
