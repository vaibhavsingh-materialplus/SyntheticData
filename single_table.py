...
def get_column_plot(real_data, synthetic_data, metadata, column_name, plot_type=None):
    ...
    return visualize.get_column_plot(
...
def get_column_pair_plot(
    ...
    require_subsample = sample_size and sample_size < min(len(real_data))
    if require_subsample:
        real_data = real_data.sample(n=sample_size)
        synthetic_data = synthetic_data.sample(n=sample_size)

    return visualize.get_column_pair_plot(real_data, synthetic_data, column_names, plot_type)



def get_column_triple_plot(
    real_data, synthetic_data, metadata, column_names, plot_type=None, sample_size=None
):
    """Get a plot of the real and synthetic data for a given column pair.
    ...
    return visualize.get_column_triple_plot(real_data, synthetic_data, column_names, plot_type)



def get_column_quad_plot(
    real_data, synthetic_data, metadata, column_names, plot_type=None, sample_size=None
):
    """Get a plot of the real and synthetic data for a given column pair.
    ...
    return visualize.get_column_quad_plot(real_data, synthetic_data, column_names, plot_type)